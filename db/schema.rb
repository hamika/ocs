...
ActiveRecord::Schema.define(version: 20170910064446) do
  ...
  create_table "schedule_customers", force: :cascade do |t|
    t.bigint "schedule_id"
    t.bigint "customer_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["customer_id"], name: "index_schedule_customers_on_customer_id"
    t.index ["schedule_id"], name: "index_schedule_customers_on_schedule_id"
  end
  ...
  create_table "schedules", force: :cascade do |t|
    ...
    t.boolean "activity_setup"
    t.boolean "activity_interview"
    t.boolean "activity_inspection"
    t.boolean "activity_presentation"
    t.boolean "activity_engagement"
  ...
  add_foreign_key "schedule_customers", "customers"
  add_foreign_key "schedule_customers", "schedules"
